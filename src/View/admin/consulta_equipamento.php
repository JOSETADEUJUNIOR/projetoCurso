...
<body class="hold-transition sidebar-mini">
                                            ...
                                            <?php foreach ($equipamento as $equip) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="#" onclick="ExcluirModal('<?= $equip['id']?>', '<?= $equip['descricao']?>')" data-toggle="modal" data-target="#modalExcluir" class="btn btn-danger btn-xs">Excluir</a>
                                                    </td>
                                                </tr>
                                            <?php } ?>
    ...
    <!-- /.content-wrapper -->
      <!-- /.content-wrapper -->
      <form action="consulta_equipamento.php" method="post">
