            ...
            <section class="content">
                ...
                <div class="card">
                    ...
                    <form action="equipamento.php" method="post" id="form_equipamento">
                        <input type="hidden" name="idEquip" id="idEquip" value="<?= $id?>">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control obg" id="identificacao" name="identificacao" value="<?= $id!='' ? $dados[0]['identificacao'] : ''?>">
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                        ...
                        <button class="btn btn-success" onclick="return CadastrarEquipamento('form_equipamento')" name="btn_cadastrar"><?= $id=='' ? 'Novo Equipamento':'Alterar Equipamento'?></button>
